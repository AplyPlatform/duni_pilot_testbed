...
function appendFlightListTable(target, item) {
    ...
    if(isSet(youtube_data_id)) {
    		appendRow = appendRow + "<div class='col-md-4'><div id='youTubePlayer_" + tableCount + "'><iframe id='youTubePlayerIframe_" + tableCount + "' width='100%' height='200' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture'></iframe></div></div>";
    }
