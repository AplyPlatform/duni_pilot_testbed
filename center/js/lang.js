...
var LANG_JSON_DATA = {
	"KR": {
        ...
        "label_compass_file_drop_area" : "이곳에 드론의 영상과 DJI GO v4, Pilot, Litchi 비행기록 파일을 올려주세요.",
        ...
        "msg_on_ready" : "대기중",
        "msg_accepted" : "접수완료",
        "msg_drop_flightrecord_file": "1. 이곳에 드론의 영상과 DJI GO 4, PILOT, Litch 앱의 비행기록 파일(*.txt, *.csv)을 올려주세요.<br>2. 드론의 영상만 올릴 수도 있습니다.<br>3. 비행기록 파일만 올릴 수도 있습니다.",
